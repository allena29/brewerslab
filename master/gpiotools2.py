...
class gpiotools2:
	...
	def __init__(self):
		...
		self.PINS={
			...
			'swFerm':  {'input':True,'pin':5,'setup':False,'inverse':True,'pup':True},
			'swHlt':  {'input':True,'pin':6,'setup':False,'inverse':True,'pup':True},
			'swMash':  {'input':True,'pin':12,'setup':False,'inverse':True,'pup':True},
			'swPump':  {'input':True,'pin':13,'setup':False,'inverse':True,'pup':True},
			'swSparge':  {'input':True,'pin':19,'setup':False,'inverse':True,'pup':True},
			'swBoil':  {'input':True,'pin':16,'setup':False,'inverse':True,'pup':True},
			...
			'pRotaryA' : {'input':True,'pin':22,'setup':False,'inverse':True,'pup':True}, 
			'pRotaryB' : {'input':True,'pin':17,'setup':False,'inverse':True,'pup':True}, 		
...
class gpioRotary:
	...
	def __init__(self):
		...
		if os.path.exists("simulator"):	return
		#GPIO.setmode(GPIO.BOARD) 
		GPIO.setmode(GPIO.BCM) 
		# The following lines enable the internal pull-up resistors 
		# on version 2 (latest) boards 
