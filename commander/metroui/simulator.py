...
print "	<table border=0 cellspacing=0 cellpadding=0 width=100%%>"
print "	<tr>"
print "	<td id='lcd0' class='bg-darkBlue fg-white'><font face='courier'>....</font></td>"
print "	</tr>"
print "	<tr>"
print "	<td id='lcd1' class='bg-darkBlue fg-white'><font face='courier'>....</font></td>"
print "	</tr>"
print "	<tr>"
print "	<td id='lcd2' class='bg-darkBlue fg-white'><font face='courier'>....</font></td>"
print "	</tr>"
print "	<tr>"
print "	<td id='lcd3' class='bg-darkBlue fg-white'><font face='courier'>....</font></td>"
print "	</tr>"
print "	</table>"
...
print "	<td align=left><a href=javascript:button('swHlt')><img id='swHlt'src='/metroui/realtimeview/pushbutton.png' width=44 height=44 border=0></a></td>"
...
print "	<td align=left><a href=javascript:button('swSparge')><img id='swSparge'src='/metroui/realtimeview/pushbutton.png' width=44 height=44 border=0></a></td>"
...
print "	<td align=left><a href=javascript:button('swBoil')><img id='swBoil'src='/metroui/realtimeview/pushbutton.png' width=44 height=44 border=0></a></td>"
...
print "	<td align=left><a href=javascript:button('swMash')><img id='swMash'src='/metroui/realtimeview/pushbutton.png' width=44 height=44 border=0></a></td>"
...
print "	<td align=left><a href=javascript:button('swFerm')><img id='swFerm'src='/metroui/realtimeview/pushbutton.png' width=44 height=44 border=0></a></td>"
print "	<td><font size=2>Fermentation</font></td>"
print "	<tr>"
print "	<td>&nbsp;</td>"
print "	<td align=left><a href=javascript:button('swPump')><img id='swPump'src='/metroui/realtimeview/pushbutton.png' width=44 height=44 border=0></a></td>"
