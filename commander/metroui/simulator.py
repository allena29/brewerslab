...
print "	<tr>"
print "	<td align=right><a href=javascript:button('pLeft')><img src='/metroui/realtimeview/pushbutton.png' width=44 height=64 border=0></a></td>"
...
print " <td width=10>&nbsp;</td>"
print "	<td align=left><a href=javascript:button('pLeft')><img src='/metroui/realtimeview/pushbutton.png' width=44 height=64 border=0></a></td>"
